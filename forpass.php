...
include("conn.php");
 if(isset($_REQUEST['submit']))
 {
    $u=$_REQUEST['name'];
    $p=$_REQUEST['Password'];
    $cp=$_REQUEST['conPassword'];

    if($p == $cp)
    {
    $q="update login set Password='$p' where Username='$u'";
    ...
    {
        echo "Passwords dos not match. Please try again.";
    }
...
<div class="contact-container">
  ...
  <div class="right-col">
    ...
    <h1>Sign Up</h1>
      ...
      <input type="password" id="conpass" name="conPassword" placeholder="Enter your password again" required>
        <button type="submit" id="submit" name="submit">Sign Up</button><!--</a>-->
