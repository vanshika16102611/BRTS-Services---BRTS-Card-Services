 ...
 if(isset($_REQUEST['submit']))
{
 ...
 $Inquiry=$_REQUEST['Inquiry'];
  ...
  $q="insert into inq(Inquiry) values('$Inquiry')";
 
 if(mysqli_query($coon,$q))
 {
    echo "Inquiry send, We will reply you soon";
 }
 else
 {
...
<div class="contact-container">
  ...
  <div class="right-col">
    ...
    <h1>Inquiry Form</h1>
      ...
      <input type="text" id="inquiry" name="Inquiry" placeholder="Enter your question here" required>
