 ...
 if(isset($_REQUEST['submit']))
{
 ...
 $Bono=$_REQUEST['bonof'];
  ...
  $q="insert into srecharge(SUnumber,Plan,Bono) values('$SUnumber','$Plan','$Bono')";
...
<div class="contact-container">
  ...
  <input type="text" id="sunumber" name="SUNumber" placeholder="Enter Your SU Number" required>
      <label for="SelectPerson">Recharge plan</label>
          <select class="form-select bg-white border-5" id="SelectPerson" name="plan">
      ...
      <label for="bonof">Bonofide</label>
  <input type="file" name="bonof" id="bonof" accept=".pdf" required>
      <p>(Note:Max file size: 10MB. Allowed format: PDF.)</p>
